...
//
Route::get('/cms/fin/orders/count_guest','budisteikul\tourcms\Controllers\OrderController@countGuest')->middleware(['web','auth','verified','CoreMiddleware','SettingMiddleware']);
...
Route::get('/cms/fin/orders/create/smt','budisteikul\tourcms\Controllers\OrderController@create_smt')->middleware(['web','auth','verified','CoreMiddleware','SettingMiddleware']);
...
//Refund
Route::resource('/cms/refund','budisteikul\tourcms\Controllers\RefundController',[ 'names' => 'route_tourcms_refund' ])
	->middleware(['web','SettingMiddleware']);

...
<div class="form-group">
	...
	<input type="text" id="name" name="name" class="form-control" placeholder="Name" autocomplete="off" value="{{ $partner->name }}">
</div>

<div class="form-group">
	<label for="description">Description :</label>
    <textarea class="form-control tinymce" id="description" name="description" rows="3">{{ $partner->description }}</textarea>
</div>
...
function UPDATE()
{
	...
	$.ajax({
		...
		type: 'PUT',
		url: '{{ route('route_tourcms_partner.update',$partner->id) }}'
		}).done(function( data ) {

        		...
        		ok: {
            		...
            		action: function(){
                 		 var table = $('#dataTableBuilder').DataTable();
     						   ...
     						   type: 'DELETE',
     						   url: '{{ route('route_tourcms_closeout.index') }}/'+ id
						        }).done(function( msg ) {
...
<div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row">
                	<div class="col">
                    <button type="button" class="btn btn-primary"  onclick="CREATE(); return false;"><b class="fa fa-plus-square"></b> Create Close Out</button>
                    </div>

@extends('coresdk::layouts.page',['mainTitle'=>'Voucher'])
@section('content')
@push('scripts')
...
@endpush
                ...
                <div class="row">
                	<div class="col">
                    <button type="button" class="btn btn-primary"  onclick="CREATE(); return false;"><b class="fa fa-plus-square"></b> Create Voucher</button>
                    </div>

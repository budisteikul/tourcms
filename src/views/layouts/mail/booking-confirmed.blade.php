...
.ExternalClass div {
  ...
  <body style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
    <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Have a good day, thank you for your booking with {{env('APP_NAME')}}. Your booking number is : {{$shoppingcart->confirmation_code}}</span>
                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; box-sizing: border-box; width: 100%;" width="100%">
                          <tbody>
                            <tr>
                              <td align="left" style="font-family: sans-serif; font-size: 14px; font-weight: normal; vertical-align: top; padding-bottom: 15px;" valign="top">
                                        ...
                                        <hr style="height:1px;border:none;color:#EEE;background-color:#EEE;" />
                                        Follow link below to to download your invoice.<br>
                                        <a href="{!!$shoppingcart->url!!}/booking/receipt/{{$shoppingcart->session_id}}/{{$shoppingcart->confirmation_code}}" target="_blank" style="text-decoration: none;">View booking
                                        </a>

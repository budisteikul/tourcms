...
<!-- ##################################################################### -->
 <!-- ##################################################################### -->
      ...
      @php
        $collapsed = 'collapsed';
        $show = '';        
        if(request()->is('cms/fin/profitloss*') || request()->is('cms/fin/tax*') || request()->is('cms/fin/transactions*') || request()->is('cms/fin/neraca*') || request()->is('cms/fin/orders*') || request()->is('cms/fin/pettycash*') || request()->is('cms/fin/expenses*'))
        {
          $collapsed = '';
          $show = 'show';
        }

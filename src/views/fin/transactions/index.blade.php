...
@extends('coresdk::layouts.page',['mainTitle'=>'Transaction'])
@section('content')
@push('scripts')
<script type="text/javascript">
	...
	function VIEW_PAYMENT()
	{
		$.fancybox.open({
        	type: 'ajax',
       	 	src: '{{ route('route_fin_transactions.index') }}/payment',
			modal: true,
          touch: false,
          autoFocus: false
   		});	
...
@endpush
                	...
                	<div class="row w-100">
                	<div class="col  text-left">
                   		<button type="button" class="btn btn-primary"  onclick="CREATE(); return false;"><b class="fa fa-plus-square"></b> Create Transaction</button>
                   		<button type="button" class="btn btn-info"  onclick="VIEW_PAYMENT(); return false;"><b class="fa fa-plus-square"></b> Pending Transaction</button>
                    </div>

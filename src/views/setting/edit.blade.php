...
<div class="form-group">
	...
	<input type="text" id="name" name="name" class="form-control" placeholder="Name" autocomplete="off" value="{{ $setting->name }}">
</div>
...
function UPDATE()
{
	...
	$.ajax({
		...
		type: 'PUT',
		url: '{{ route('route_tourcms_setting.update',$setting->id) }}'
		}).done(function( data ) {

...
@extends('coresdk::layouts.input-form',["mainTitle" => "Edit Product"])
@section('content')
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="category_id">
      ...
      <option value="{{ $category->id }}" {{  ($category->id == $product->category_id) ? "selected" : "" }}>{{ $CategoryHelper->nameCategory($category->id,"-") }}</option>
      @endforeach
    </select>
  </div>
...
function UPDATE()
{
	...
	$.ajax({
		...
		type: 'PUT',
		url: '{{ route('route_tourcms_product.update',$product->id) }}'
		}).done(function( data ) {

            ...
            <div class="card mb-2 ">
                <div class="card-header bg-secondary">CUSTOMER</div>
                  <ul class="list-group list-group-flush ml-0 mr-0 pl-0 pr-0">
                    <li class="list-group-item"><a href="{{env("APP_API_URL")}}/api/pdf/invoice/{{ $shoppingcart->session_id }}/Invoice-{{ $shoppingcart->confirmation_code }}.pdf"><i class="far fa-file-pdf"></i> Invoice-{{ $shoppingcart->confirmation_code }}.pdf</a></li>

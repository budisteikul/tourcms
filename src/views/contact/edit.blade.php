...
<div class="tab-pane fade pt-4" id="nav-menu7" role="tabpanel" aria-labelledby="nav-menu7-tab">
        ...
        <button type="button" class="btn btn-danger mb-2" id="template2002"  onclick="sendTemplate(2002); return false;"><i class="fas fa-paper-plane"></i> Product Jogja Night Food Tour</button>
</div>

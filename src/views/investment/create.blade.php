@extends('coresdk::layouts.input-form',["mainTitle" => "Create Investment"])
@section('content')			
...
<div class="form-group">
	...
	<input type="number" step="0.01" id="portfolio" name="portfolio" class="form-control" placeholder="0">
</div>

<div class="form-group">
	<label for="return">Return :</label>
	<input type="number" step="0.01" id="return" name="return" class="form-control" placeholder="0">
</div>
...
function STORE()
{
	...
	$.ajax({
		...
		type: 'POST',
		url: '{{ route('route_tourcms_investment.store') }}'
		}).done(function( data ) {

            ...
            ->addColumn('action', function ($id) {
                ...
                <div class="btn-toolbar justify-content-end">
                    <div class="btn-group mr-2" role="group">
                        ...
                        <button id="btn-edit" type="button" onClick="SHOW(\''.$id->id.'\'); return false;" class="btn btn-sm btn-warning pt-0 pb-0 pl-1 pr-1"><i class="fa fa-edit"></i> Download QRCODE</button>

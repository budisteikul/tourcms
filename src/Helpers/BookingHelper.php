...
use budisteikul\tourcms\Helpers\VoucherHelper;
...
class BookingHelper {
	...
	{
        $pdf = PDF::setOptions(['tempDir' =>  storage_path(),'fontDir' => storage_path(),'fontCache' => storage_path(),'isRemoteEnabled' => true])->loadView('tourcms::layouts.manual.manual', compact('shoppingcart'))->setPaper('a4', 'portrait');
        return $pdf;
	}
	...
	public static function create_invoice_pdf($shoppingcart)
	{
        ...
        $pdf = PDF::setOptions(['tempDir' =>  storage_path(),'fontDir' => storage_path(),'fontCache' => storage_path(),'isRemoteEnabled' => true])->loadView('tourcms::layouts.pdf.invoice', compact('shoppingcart','qrcode'))->setPaper('a4', 'portrait');
	...
	public static function create_instruction_pdf($shoppingcart)
	{
		...
		$pdf = PDF::setOptions(['tempDir' => storage_path(),'fontDir' => storage_path(),'fontCache' => storage_path(),'isRemoteEnabled' => true])->loadView('tourcms::layouts.manual.bank_transfer', compact('shoppingcart'))->setPaper($customPaper,'portrait');
		return $pdf;
	}
	...
	public static function create_ticket_pdf($shoppingcart_product)
	{
        ...
        $pdf = PDF::setOptions(['tempDir' => storage_path(),'fontDir' => storage_path(),'fontCache' => storage_path(),'isRemoteEnabled' => true])->loadView('tourcms::layouts.pdf.ticket', compact('shoppingcart_product','qrcode'))->setPaper($customPaper);
        return $pdf;
	}
